...
if (typeof exports === "object") {
    ...
    cms.markdown = function( filecontent, templateData ) {
        ...
        filecontent = filecontent.replace(/@\[(.*?)\]\((.*?)\)/gi , '<span class="scrollcontainer">![$1]($2)</span>' );
        
        // handle my custom video inserts
        // %[width,height,posterimageurl,mp4url,webmurl]
        filecontent = filecontent.replace(/%\[\s*(.*)\s*,\s*(.*)\s*,\s*(.*)\s*,\s*(.*)\s*,\s*(.*)\s*\]/gi, videoTag);
    ...
    function videoTag(p0,p1,p2,p3,p4,p5) {
        return '\n<div class="embeddedvideo">\n<video width="100%" height="100%" poster="'+p3+'" controls="controls" preload="none" style="width:100%; height:100%;">' +
        ...
        '        <img src="'+p3+'" width="'+p1+'" height="'+p2+'" title="No video playback capabilities" />' + //Image as a last resort 
        '    </object>'+ 
        '</video>\n</div>\n'
    }
