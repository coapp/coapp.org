...
if (typeof exports === "object") {
  ...
  Showdown.parse = function (md, gh, some_urls, some_titles ) {
    var converter = new Showdown.converter();
    return converter.makeHtml(md, gh, some_urls, some_titles );
  };
}
...
this.makeHtml = function(text, gh , some_urls, some_titles ) {
...
//
    ...
    if( typeof(some_urls) == "object" ) {
        console.log("YES");
        for(var ndx in some_urls) {
            g_urls[ndx] some_urls[ndx];
        }
    }

    if( typeof(some_titles) == "object" ) {
        for(var ndx in some_titles) {
            g_titles[ndx] some_titles[ndx];
        }
    }
